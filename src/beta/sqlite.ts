...
export type Middleware = (
	...
	tx: SQLiteTransaction<"async", any, any, any, any>,
) => Promise<unknown>;

export type SyncMiddleware = (
	next: () => unknown,
	tx: SQLiteTransaction<"sync", any, any, any, any>,
) => unknown;

export function withMiddleware<
	TDb extends BaseSQLiteDatabase<"async", any, any, any, any>,
>(db: TDb, middleware: Middleware): TDb;
export function withMiddleware<
	TDb extends BaseSQLiteDatabase<"sync", any, any, any, any>,
